...
export const SAMPLE_PERFUMES = [
  ...
  },
  {
    ...
    price: 'Consultar',
    description: 'Una fragancia nicho luminosa y frutal, con citricos mediterraneos en la salida, frutas dulces en el corazon y un fondo limpio de almizcle blanco, ambar y vainilla.',
    imageUrl: '/perfumes/Erba Pura Xerjoff.webp',
    notes: { top: 'Limon, Bergamota de Calabria, Naranja siciliana', heart: 'Frutas mediterraneas', base: 'Ambar, Vainilla de Madagascar, Almizcle blanco' },
    longevity: '9-12 horas',
    intensity: 5,
    occasion: 'Dia, Verano, Salidas',
    categories: ['nicho'],
    visible: true,
  },
  {
    ...
    price: 'Consultar',
    description: 'Un disenador ambarado y fougere que combina vainilla bourbon con lavandin y vetiver ahumado, logrando un aroma nocturno, moderno y sensual sin perder elegancia.',
  ...
  },
  {
    ...
    price: 'Consultar',
    description: 'Una version mas intensa y elegante de Scandal, con geranio vibrante, tonka adictiva y sandalo calido para una presencia nocturna mas profunda.',
    imageUrl: '/perfumes/Scandal Le Parfum.webp',
    notes: { top: 'Geranio', heart: 'Haba tonka', base: 'Sandalo' },
    longevity: '9-12 horas',
    intensity: 5,
  ...
  },
  {
    ...
    price: 'Consultar',
    description: 'Un ambarado amaderado elegante, con cardamomo especiado, lavanda e iris en el corazon y una vainilla densa que le da un perfil sobrio, sensual y muy nocturno.',
  ...
  },
  {
    ...
    price: 'Consultar',
    description: 'Un parfum intenso, dulce y calido: abre con menta fresca y lavanda, se vuelve cremoso con benjui y termina con tonka, miel, tabaco y vainilla.',
    imageUrl: '/perfumes/Jean Paul Gaultier Le Male Elixir.webp',
    notes: { top: 'Menta, Lavanda', heart: 'Benjui, Vainilla', base: 'Haba tonka, Miel, Tabaco' },
    longevity: '10-12 horas',
    intensity: 5,
    occasion: 'Noche, Fiesta, Clima fresco',
    categories: ['disenador'],
  ...
  },
  {
    ...
    price: 'Consultar',
    description: 'Un disenador gourmand y poderoso, con cardamomo especiado, acorde de toffee/caramelo y maderas ambaradas que lo vuelven magnetico para noches y clima fresco.',
  ...
  },
  {
    ...
    price: 'Consultar',
    description: 'Un fougere amaderado ambarado, dulce y envolvente, con pimienta rosa, lavanda, salvia, castana azucarada, vainilla y maderas ambaradas.',
    imageUrl: '/perfumes/Stronger With You Intensely.webp',
    notes: { top: 'Pimienta rosa, Violeta, Enebro', heart: 'Lavanda, Salvia, Canela', base: 'Madera ambarada, Vainilla, Castana azucarada, Gamuza' },
    longevity: '8-10 horas',
    intensity: 4,
  ...
  },
  {
    ...
    price: 'Consultar',
    description: 'Un disenador fresco, dulce y amaderado, con citricos italianos, menta y manzana confitada sobre una base de cedro, vetiver, patchouli, vainilla y cuero.',
    imageUrl: '/perfumes/Versace Eros Eau de Parfum.webp',
    notes: { top: 'Limon italiano, Mandarina, Menta, Manzana confitada', heart: 'Geranio, Salvia esclarea, Ambermax', base: 'Cedro, Vetiver, Patchouli, Sandalo, Vainilla, Cuero' },
    longevity: '8-10 horas',
    intensity: 4,
    occasion: 'Noche, Fiesta, Versatil',
    categories: ['disenador'],
    visible: true,
  },
];
...
export const getWhatsAppLink = (perfumeName) => {
  const msg = encodeURIComponent(`Hola, me gustaria obtener informacion sobre el perfume *${perfumeName}* de IKER PARFUM DE ROIS. Podria ayudarme?`);
