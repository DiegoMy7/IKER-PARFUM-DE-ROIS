...
export const SAMPLE_PERFUMES = [
  ...
  },
  {
    ...
    price: 170,
    description: 'Una versión más fría, fresca y cristalina del ADN Hawas: manzana helada, cítricos y anís se mezclan con ciruela, flor de naranjo y una base marina-amaderada.',
    imageUrl: '/perfumes/Hawas Ice Rasasi.webp',
    notes: { top: 'Manzana helada, limón italiano, bergamota siciliana, anís estrellado', heart: 'Ciruela, flor de naranjo, cardamomo, acorde marino helado', base: 'Almizcle, ámbar, madera flotante, musgo cristalizado' },
    longevity: '8-10 horas',
    intensity: 4,
  ...
  },
  {
    ...
    price: 170,
    description: 'Una mezcla cremosa y exótica: piña con crème brûlée, especias suaves en el corazón y una base de vainilla, sándalo, cashmeran y musgo.',
    imageUrl: '/perfumes/Badee Al Oud Honor and Glory Lattafa.webp',
    notes: { top: 'Piña, crème brûlée', heart: 'Canela, cúrcuma, pimienta negra, benjuí', base: 'Vainilla, sándalo, cashmeran, musgo' },
    longevity: '8-10 horas',
    intensity: 4,
  ...
  },
  {
    ...
    price: 210,
    description: 'Una lectura más intensa de la línea Hawas, con salvia clara, acorde marino y jazmín sobre un fondo mineral de ámbar gris, ámbar y madera flotante.',
    imageUrl: '/perfumes/Hawas Fire Rasasi.webp',
    notes: { top: 'Salvia clara', heart: 'Acorde marino, jazmín egipcio', base: 'Ámbar gris, ámbar, notas minerales, madera flotante' },
    longevity: '8-10 horas',
    intensity: 4,
